...
(
    ...
    [Parameter(HelpMessage = 'Experimental features of AdsSuck-Windows are not included')]
    [switch]$exp_standart,
...
function CallLang($clg) {
    ...
    $urlLang = "https://raw.githubusercontent.com/KieranK07/AdsSuck-WIndows/main/scripts/installer-lang/$clg.ps1"
...
if ($langCode -eq 'ru') { 
    $ru = $true
    $urlru = "https://raw.githubusercontent.com/KieranK07/AdsSuck-Windows/main/patches/Augmented%20translation/ru.json"
...
function downloadScripts($param1) {
    ...
    if ($ru -and $param1 -eq "cache-spotify") {
        $links2 = "https://raw.githubusercontent.com/KieranK07/AdsSuck-Mac/main/scripts/cache/cache_spotify_ru.ps1"
    }
    if (!($ru) -and $param1 -eq "cache-spotify" ) { 
        $links2 = "https://raw.githubusercontent.com/KieranK07/AdsSuck-Windows/main/scripts/cache/cache_spotify.ps1"
    }
    
    $web_Url_prev = "https://github.com/mrpond/BlockTheSpot/releases/latest/download/chrome_elf.zip", $links, `
        $links2, "https://raw.githubusercontent.com/KieranK07/AdsSuck-Windows/main/scripts/cache/hide_window.vbs", `
        "https://raw.githubusercontent.com/KieranK07/AdsSuck-Windows/main/scripts/cache/run_ps.bat"
...
# Recommended version for AdsSuck-Windows
...
$url = "https://raw.githubusercontent.com/KieranK07/AdsSuck-Windows/main/patches/patches.json"
$retries = 0
...
if ($test_js) {
    ...
    If ($xpui_test_js -match 'patched by AdsSuck-Windows') {
...
If ($test_spa) {
    ...
    If ($patched_by_spotx -match 'patched by AdsSuck-Windows') {
        $zip.Dispose()    
